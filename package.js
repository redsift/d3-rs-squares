...
export var scripts = {"serve":"gulp -o d3-rs-calendar-chart -g d3-selection -g @redsift/d3-rs-svg serve","build":"gulp -o d3-rs-calendar-chart -g d3-selection -g @redsift/d3-rs-svg build","pretest":"npm outdated && npm run build","test":"tape 'test/**/*-test.js' && eslint index.js src","version":"json2module package.json > package.js","prepublish":"npm run build"};
export var dependencies = {"d3-selection":"~0.8.0","d3-time-format":"~0.4.0","@redsift/d3-rs-svg":"~0.2.3"};
