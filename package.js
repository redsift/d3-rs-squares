...
export var scripts = {"serve":"gulp -o d3-rs-calendar-chart -g d3-selection -g d3-time-format -g d3-array -g d3-collection -g d3-time -g d3-scale -g @redsift/d3-rs-svg serve","build":"gulp -o d3-rs-calendar-chart -g d3-selection -g d3-time-format -g d3-array -g d3-collection -g d3-time -g d3-scale -g @redsift/d3-rs-svg build","pretest":"npm outdated && npm run build","test":"tape 'test/**/*-test.js' && eslint index.js src","version":"json2module package.json > package.js","prepublish":"npm run build"};
